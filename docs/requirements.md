...
3. User Stories (minimum 6)
    ...
    3.2 As a customer, sometime I have grown impatient waiting my turn to borrow a book.
    3.3 As a customer, I sometimes forgot to return a book, causing me to pay an extra fine.
    3.4 As a Library Staff, manual records are hard to manage.
    3.5 As a Library Staff, some records gets lost and hard to recover.
    3.6 As a Library Staff, its hard to produce an accurate report. 

4. Acceptance Criteria
    Can easily track the status of the book
